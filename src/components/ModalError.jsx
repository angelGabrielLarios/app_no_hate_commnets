...
export const ModalError = ({ ModalErrorRef }) => {
    return (
        <>
            <dialog
                ref={ModalErrorRef}
            ...
            >
                <div className="modal-box text-error">
                    ...
                    <h3 className="font-bold text-base text-center">Error!</h3>
                    <p className="py-4 text-center text-sm">No se puede agregar su comentario porque se ha dectectado que es inapropiado y fomenta el odio</p>
                </div>
            </dialog>
        </>
    )
